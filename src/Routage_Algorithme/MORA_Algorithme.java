    ...
    public void start() {
        ...
        if (x_source < x_destination)//////////////////////// de haut vers le bas ///////
        {
            ...
            if (x_source > x_destination)///////////////////////// de bas vers le haut//////////
            {
                ...
                if ((y_source - y_destination) < 0) // de gauche e droite
...
//////////////////////////cette methode permet d'ajouter le volume de donnees echangees sur le lien/////////////
...
//////////////////////////
    ...
    public void lancer_envoie(int x, int y, int x1, int y1, int M) {
        ...
        //System.out.println(" id   "+p.id+" apres   x   "+p.x_inter+"   y  "+p.y_inter+"   t arrive "+p.T_fin);
...
////////////////////////
    ...
    public void haut_vers_bas() {
        ...
        {
//// verifier si le lien vers la droite est moins charge que celui du bas /////
            ...
            if (y_source > y_destination)   //////////////// de droite e gauche ///////////
...
//////////////////////////////////
    ...
    public void bas_vers_haut() {
        ...
        if (y_source < y_destination)        ////// de gauche e droite //////////
        {
            //// verifier si le lien vers la droite est moins charge celui vers le haut /////
