...
/**
 * cette classe permet de générer les lien entre les processeurs 
 *
 */
...
public class GenererChannel {
	...
	/**
	 * Cette methode retourn la list des lien (entre les processeur) ou chaque lien est représenté par un identificateur unique
	 * 
	 * @return listChannel 
	 */
