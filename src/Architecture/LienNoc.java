...
/**
 * cette classe represente un lien entre  2 processeurs, il est caractériser par
 * <ul> 
...
public class LienNoc {
	...
	/**
	 *  List des temps de décrémentation de la charge du lien
	 * 	
	 */
	...
	/**
	 * Cette methode définit le voisin  
...
public  void set_file()
	...
	{ /// diminuer la valeur de nombre de paquets qui reste a envoyer selon le débit ////
