...
/**
 * Cette Classe permet de créer le NOC  
 * Cette Classe nécessite de prendre en paramètre un fichier qui définit le type de chaque processeur 
 * 
 *
 *
 */
public class Create_NOC {
	...
	/**
	 * Définir une list de processeur qui permet de facilité l'accée aux information de chaque processeur   
	 * 
	 * 
	 */
