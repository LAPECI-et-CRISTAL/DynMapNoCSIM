...
public class TaskData extends javax.swing.JFrame implements ActionListener {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Données partagées");
...
//		donnée_fils.add(Integer.parseInt(jTextField1.getText().trim()));
		jTextField2.setText("");
		jTextField3.setText("");
	...
	if(pol.getText().equals("Terminer"))
	{
		...
		donnée_fils=Integer.parseInt(jTextField1.getText().trim());
		Set_Donnee_Partagee(id,donnée_fils,TreeDrawer.selectedcomponent);
	...
	
	{
		for(int i=0;i<ApplicationInterface.task.size();i++)
				...
				if(ApplicationInterface.task.get(i).id==id_pere)
				{
					...
					ApplicationInterface.task.get(i).donnée_fils.add(donne);
				}
