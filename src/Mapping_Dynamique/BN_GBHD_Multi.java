...
// décrementer la taille de la mémoire du proc en fonction de la taille de la tâche
Create_NOC.getNOC()[x1][y1].setMem(t.getTailleTache(Create_NOC.getNOC()[x1][y1].getType()),1);

Create_NOC.getNOC()[x1][y1].File.add(t);

Simulator.setEnergy(Energie);//ajouter l energie consommé lors de la recherche à l energie total consommé par l application
